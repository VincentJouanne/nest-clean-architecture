...
describe('[e2e] PATCH /v1/users/{:userId}/verify', () => {
    ...
    it('Should respond 422 for invalid verification code format', async () => {
        const response = await request(app.getHttpServer()).patch('/v1/users/c017f4a9-c458-4ea7-829c-021c6a608534/verify').send({ verification_code: '1' });
        expect(response.status).toBe(422);
    });
    ...
    it('Should respond 404 if user does not exists', async () => {
        ...
        const response = await request(app.getHttpServer()).patch('/v1/users/a017f4a9-c458-4ea7-829c-021c6a608534/verify').send({ verification_code: '1234' });
    ...
    it('Should respond 401 if verification codes does not match', async () => {
        ...
        const response = await request(app.getHttpServer()).patch('/v1/users/c017f4a9-c458-4ea7-829c-021c6a608534/verify').send({ verification_code: '1111' });
    ...
    it('Should respond 200 for a valid verification code', async () => {
        ...
        const response = await request(app.getHttpServer()).patch('/v1/users/c017f4a9-c458-4ea7-829c-021c6a608534/verify').send({ verification_code: '1234' });
